...
import type { UpdateNotebooksRequest } from "@/dto/notebook"
...
export function Sidebar({
    ...
    const saveNotebookName = async () => {
        if (editingNotebook && editingName.trim()) {
            ...
            const request:UpdateNotebooksRequest ={
                name: editingName.trim(),
            }
            await axios.put<BaseResponse<UpdateNotebooksRequest>>(`${AppConfig.baseURL}/notebook/${editingNotebook}`, request)
